...
Begin
  RegisterComponents('DGH Custom SynEdit Controls', [TSynMDSyn]);
End;

Resourcestring
  SYNS_FilterRegularExpressions = 'Markdown Files (*.regex)|*.regex';
  SYNS_LangRegularExpressions = 'Markdown';
  SYNS_FriendlyLangRegularExpressions = 'Markdown';
...
procedure TSynMDSyn.FreeTextOpenProc;
begin
  inc(Run);
  fRange := rsFreeText;
  fTokenID := tkFreeText;
...
procedure TSynMDSyn.FreeTextProc;
begin
  Case FLine[Run] Of
    #0: NullProc;
    #10: LFProc;
...
Function TSynMDSyn.FuncKeyword(Index: Integer): TtkTokenKind;

Begin
  Result := tkRules;
End;

Procedure TSynMDSyn.AddAndUpdateAttributes(Attribute: TSynHighlighterAttributes; ForeColour,
  BackColour: TColor; FontStyle: TFontStyles);
...
Function TSynMDSyn.AltFunc(Index: Integer): TtkTokenKind;
...
Procedure TSynMDSyn.OptionalOperatorProc;
...
procedure TSynMDSyn.DoubleLiteralOpenProc;
begin
  inc(Run);
...
procedure TSynMDSyn.DoubleLiteralProc;
begin
  Case FLine[Run] Of
    #0: NullProc;
    #10: LFProc;
...
Procedure TSynMDSyn.CharClassProc;
...
Procedure TSynMDSyn.CPPCommentOpenProc;
...
Procedure TSynMDSyn.CPPLineCommentProc;
...
Procedure TSynMDSyn.CPPBlockCommentProc;
...
Procedure TSynMDSyn.UnknownProc;
...
Function TSynMDSyn.GetTokenID: TtkTokenKind;
...
Procedure TSynMDSyn.GroupingProc;
...
Procedure TSynMDSyn.RuleOpenProc;
...
Procedure TSynMDSyn.RuleNameProc;
...
Function TSynMDSyn.GetSampleSource: UnicodeString;
...
Procedure TSynMDSyn.RepeatOperatorProc;
...
procedure TSynMDSyn.SingleLiteralOpenProc;
...
procedure TSynMDSyn.SingleLiteralProc;
begin
  Case FLine[Run] Of
    #0: NullProc;
    #10: LFProc;
